...
public class GIConstants {
    ...
    public static final String ENTER_DATABASE_MESSAGE = "Enter Database name: ";
    ...
    TABLE(S) Constants
     */
    public static final String TABLES_TITLE = "Table(s)";
    public static final String CREATE_NEW_TABLE_TITLE = "Create New Table";
    public static final String ENTER_TABLE_MESSAGE = "Enter Table name: ";
